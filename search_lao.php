<?php
// ==========================================
// ໄຟລ໌ຄົ້ນຫາຄຳສັບພາສາລາວ ແລະ Category ໃນ room_service.php (Lao Word Search Tool)
// ------------------------------------------
// ໜ້າທີ່: ອ່ານເນື້ອຫາທັງໝົດໃນ room_service.php ແລ້ວກວດສອບແຕ່ລະແຖວທີ່ມີຄຳວ່າ 'ອາຫານ', 'ເຄື່ອງດື່ມ' ຫຼື 'category'
// ເພື່ອກວດຫາ ແລະ ແປງປ້າຍຊື່ສິນຄ້າ ຫຼື ໝວດໝູ່ທີ່ຍັງເປັນພາສາລາວຢູ່.
// ==========================================

// ໂຫຼດເນື້ອຫາທັງໝົດຂອງໄຟລ໌ room_service.php
$content = file_get_contents('room_service.php');
